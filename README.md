...
[![GitHub Actions Workflow Status](https://img.shields.io/github/actions/workflow/status/mytake2/context-logger/build-and-publish.yml)](https://github.com/mytake2/context-logger/actions/workflows/build-and-publish.yml) [![GitHub Downloads (all assets, all releases)](https://img.shields.io/github/downloads/mytake2/context-logger/total)](https://github.com/mytake2/context-logger/pkgs/npm/context-logger) [![GitHub Release](https://img.shields.io/github/v/release/mytake2/context-logger)](https://github.com/mytake2/context-logger/releases/latest)
